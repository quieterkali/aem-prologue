...
;(function ($, ns, channel, window, undefined) {
    ...
    ns.history.actions.fd.TableMoveRowUp = function (path, insertPath, componentType, createParams) {
    ...
    ns.util.inherits(ns.history.actions.fd.TableMoveRowUp, ns.history.actions.fd.DefaultAction);

    /** Implements Granite.author.history.Action#undo
     * Move the specified row down.
     * @param cfg
     */
    ns.history.actions.fd.TableMoveRowUp.prototype.undo = function (cfg) {
        var self = this,
     ...
     * @param cfg
     */
    ns.history.actions.fd.TableMoveRowUp.prototype.redo = function (cfg) {
        var self = this,
            GuideTableEdit = guidelib.author.AuthorUtils.GuideTableEdit,
            editable = window.guidelib.author.editConfigListeners._getEditable(self.path);
    ...
    // register action
    ns.history.actions.Registry.register("TableMoveRowUp", ns.history.actions.fd.TableMoveRowUp);
