...
(function($) {
	...
	function dd(element, settings) {
		...
		var parseOption = function(opt) {
			...
			if (opt !== undefined) {
				...
				style = $(opt).prop("data-style") || $(opt).data("style") || (style || "");
				index = $(opt).index();
			};
			var o = {
				image: imagePath,
		...
		var createWrapper = function() {
			...
			var w = $("#" + element).getHiddenDimensions().outerWidth;
		...
		var childHeight = function(val) {
			...
			if (totalOptions > settings.visibleRows || settings.visibleRows) {
				...
				if (settings.rowHeight === 0) {
					settings.rowHeight = Math.ceil(firstLI.getHiddenDimensions().height);
		...
		var updateTitleUI = function(index, byvalue) {
			...
			$("#" + titleid).find("." + css.label).get(0).title = value.text;
			getElement(titleid).className = css.ddTitleText + " " + value.className;
			$("#" + titleid).get(0).style.cssText = value.style.cssText;
			//update desction
		...
		var updateUI = function(a, opt, i) { //action, index, opt
			...
			switch (a) {
				case "add":
					...
					//handling case to add in an optgroup.
					if (typeof index == "object") {
					    var label = index.label;
						var at = $("#" + childid + " span:contains("+ label +")").siblings("ul").append(li);
					}
					else if (index < 0 || !index) {
						$("#" + childid + " ul").eq(0).append(li);
					} else {
		...
		this.add = function() {
			var text, value, title, image, description, style;
			var obj = arguments[0];
			if (typeof obj == "string") {
				...
				opt.style.cssText = style;
			};
			arguments[0] = opt; //this option
			if (typeof arguments[1] == "object") {
			    var label = arguments[1].label;
                $(getElement(element)).find("optgroup[label='" + label + "']").append(arguments[0]);
			} else {
                $(getElement(element)[arguments[1]]).before(arguments[0]);
			}
			updateProp("children", getElement(element)["children"]);
    ...
    $.fn.getHiddenDimensions = function (includeMargin) {
        var $item = this,
        props = { position: 'relative !important', visibility: 'hidden !important', display: 'block !important' },
        ...
        $hiddenParents.each(function () {
            ...
            for (var name in props) {
                ...
                this.style.cssText += name + ":" + props[name] + ";";
            }
