...
var coralSelector = [".themeSliderInput"];
        ...
        adapter : function (el) {
            ...
            return {
                ...
                setValue : function (value) {
                    var $slider = field.siblings("coral-slider"),
                        normalizer = $slider.attr("normalizer"),
                        suffix = $slider.attr("suffix"),
                        userTypedSuffix = parseFloat(value) ? value.substr(parseFloat(value).toString().length) : value;
                    el.value = value;
                    if (userTypedSuffix) {
                    ...
                    $slider.get(0).value = value * normalizer;
                },
                getValues : function () {
                    if ("values" in el) {
                        return el.values;
...
/*
* No need to trigger foundtion-field-change as
* input itself trigger foundation-field-change
* when changed.
*/
}(window.jQuery));
